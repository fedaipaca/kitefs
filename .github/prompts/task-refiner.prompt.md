...
`copilot-instructions.md` is always injected into sessions — do not restate its rules. Assume its guardrails (architecture, Python style, product boundary etc.) are already in effect.

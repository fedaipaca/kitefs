...
# with `name: "<current_directory_name>"` replaced by the hardcoded MVP value.
# ---------------------------------------------------------------------------
...
# Copied byte-for-byte from docs/01-reference-use-case.md § Town Market Features
# (lines 259-289 inside the ```python``` block), including the leading file-path
# comment and trailing newline.
EXAMPLE_DEFINITION = """\
